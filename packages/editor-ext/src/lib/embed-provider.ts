...
export const embedProviders: IEmbedProvider[] = [
  ...
  },
  {
    ...
    getEmbedUrl: (match, url: string) => {
      return `https://www.figma.com/embed?url=${url}&embed_host=snowind`;
    },
  },
  {
    id: "typeform",
  ...
  },
  {
    ...
    getEmbedUrl: (match, url) => {
      ...
      return `https://miro.com/app/live-embed/${match[2]}?embedMode=view_only_without_ui&autoplay=true&embedSource=snowind`;
    },
  },
  {
    id: "youtube",
