    ...
    <Stack gap="lg">
      {!hasAccess && (
        <Alert icon={<IconInfoCircle />} title={upgradeLabel} color="blue">
          {t(
            "MCP is only available in the SnoWind enterprise edition. Contact sales@snowind.com.",
          )}
        </Alert>
      )}
        ...
        <div>
          ...
          <Text size="sm" c="dimmed">
            ...
            <Trans
              ...
              components={{
                anchor: <Anchor href="https://snowind.com/docs/user-guide/mcp" target="_blank" size="sm" />,
              }}
            />
          </Text>
        </div>
      ...
      {checked && (
        <div>
          ...
          <Text size="sm" c="dimmed" mt="xs">
            {t("Connect AI assistants with your SnoWind account via OAuth.")}
          </Text>
  ...
  return (
    <Group justify="space-between" wrap="nowrap" gap="xl" mt="md">
      <div>
        ...
        <Text size="sm" c="dimmed">
          {t(
            "AI assistants must connect with a SnoWind account via OAuth. API keys cannot be used with the MCP server.",
          )}
        </Text>
      </div>
