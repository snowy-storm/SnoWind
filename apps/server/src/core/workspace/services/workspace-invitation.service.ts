...
import InvitationEmail from '@snowind/transactional/emails/invitation-email';
import { GroupUserRepo } from '@snowind/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@snowind/transactional/emails/invitation-accepted-email';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    if (invitedByUser) {
      ...
      await this.mailService.sendToQueue({
        ...
        subject: `${newUser.name} has accepted your SnoWind invite`,
  ...
  async sendInvitationMail(
    ...
    await this.mailService.sendToQueue({
      to: inviteeEmail,
      subject: `${invitedByName} invited you to SnoWind`,
      template: emailTemplate,
    });
  }
}
