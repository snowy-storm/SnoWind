...
import { ExportDocxDto, ExportPageDto, ExportSpaceDto } from './dto/export-dto';
...
export class ExportController {
  ...
  async exportPageToDocx(
    ...
    const content = await this.docxExportService.exportPageAsDocx(page);
