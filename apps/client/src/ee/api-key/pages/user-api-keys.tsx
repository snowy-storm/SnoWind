    ...
    <>
      ...
      {mcpEnabled && (
        <Alert variant="light" color="blue" mb="md" p="sm" icon={<IconInfoCircle />}>
          <Text size="sm">
            {t(
              "Your workspace has MCP enabled. Connect AI assistants with your SnoWind account via OAuth.",
            )}{" "}
            <Anchor
              href="https://snowind.com/docs/user-guide/mcp"
              target="_blank"
              size="sm"
            >
              {t("Learn more")}
        ...
        <Group justify="space-between" align="center" mb="md">
          <Text size="sm" c="dimmed">
            <Trans
              ...
              components={{
                anchor: <Anchor href="https://snowind.com/api-docs" target="_blank" size="sm" />,
              }}
            />
          </Text>
