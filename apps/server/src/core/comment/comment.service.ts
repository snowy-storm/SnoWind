...
import { CommentRepo } from '@snowind/db/repos/comment/comment.repo';
import { Comment, Page, User } from '@snowind/db/types/entity.types';
...
export class CommentService {
  ...
  async resolve(
    ...
    if (comment.parentCommentId) {
      throw new BadRequestException('You can only resolve top-level comments');
    }
