...
import { CreateDrawingMenu } from "@/features/drawing/components/create-drawing-menu";
...
export function SpaceSidebar() {
  ...
  function handleCreateBase() {
    handleCreate(null, { isBase: true });
  }

  function handleCreateDrawing(type: DrawingType) {
    handleCreate(null, { drawingType: type });
  ...
  function handleCreateMindmap() {
    handleCreate(null, { drawingType: "mindmap" });
    if (mobileSidebarOpened) {
      toggleMobileSidebar();
    }
  }
          ...
          <div className={classes.menuItems}>
            ...
            {spaceAbility.can(
              ...
              <>
                ...
                <CreateDrawingMenu onSelect={handleCreateDrawing}>
                ...
                >
                  <div className={classes.menuItemInner}>
                    <IconMindmap size={18} className={classes.menuItemIcon} />
                    <span>{t("New mind map")}</span>
                  </div>
                </UnstyledButton>
                ...
                >
                  <UnstyledButton
                    className={classes.menu}
                    data-disabled={!hasBases || undefined}
          ...
          <Group className={classes.pagesHeader} justify="space-between">
            ...
            <Group gap="xs">
              ...
              {spaceAbility.can(
                ...
                <>
                  <Tooltip
                    label={hasBases ? t("Create base") : upgradeLabel}
                    withArrow
                    position="right"
                  >
                    <ActionIcon
                      variant="default"
                      size={18}
                      onClick={hasBases ? handleCreateBase : undefined}
                      aria-label={t("Create base")}
                      data-disabled={!hasBases || undefined}
                      style={{ opacity: hasBases ? undefined : 0.7 }}
                    >
                      <IconTable />
                  ...
                  <CreateDrawingMenu
                    onSelect={handleCreateDrawing}
                    position="bottom-end"
                  >
                    <ActionIcon
                      variant="default"
                      size={18}
                      aria-label={t("Create drawing")}
                    >
                      <IconPencilPlus />
                    </ActionIcon>
                  </CreateDrawingMenu>

                  <Tooltip label={t("Create mind map")} withArrow position="right">
                    <ActionIcon
                      variant="default"
                      size={18}
                      onClick={handleCreateMindmap}
                      aria-label={t("Create mind map")}
                    >
                      <IconMindmap size={16} />
                    </ActionIcon>
                  </Tooltip>
