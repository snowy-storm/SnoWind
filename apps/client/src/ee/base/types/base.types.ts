...
export const MAX_TABLE_GROUP_LEVELS = 5;
...
export type ViewConfig = {
  ...
  /** Table-view data row height. Omitted / unknown values mean "normal". */
  rowHeight?: "normal" | "tall" | "extraTall";
  // Kanban
...
// Absent filter, sorts, or groups means "inherit the baseline for that axis".
...
} from "@snowind/base-formula/client";
export { isErrorCell as isFormulaErrorCell } from "@snowind/base-formula/client";
